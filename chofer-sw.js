...
const CACHE_NAME = 'betangar-chofer-v33'; // v33: quitado ítem "Repuesto" del checklist (no se lleva caucho de repuesto en vía) // v31: + módulo Surtir combustible (por surtida) // v29: huecos chofer — incidencia offline no se pierde (COLA_INC), checklist en cola se fusiona, fecha 'hoy' se recalcula al amanecer
